...
const blockchainImpls = ['BTC', 'LTC', 'BCH', 'XMR', 'ETH', 'RINKEBY', 'ARBI', 'LUKSO', 'LUMIA', 'MANTA', 'CELO', 'DASH', 'FLR'];   
...
const run = async () => {
    ...
    if (nodesToInit.includes('LUMIA')) {
        ...
        console.log('running block processor for lumia', nonBlockingInfiniteLoop(lumiaWrapper));
    }
